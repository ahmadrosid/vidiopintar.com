    ...
    return (
        <section className="flex min-h-screen bg-zinc-50 px-4 py-16 md:py-32 dark:bg-transparent">
            <div className="max-w-92 m-auto h-fit w-full">
                <div className="p-6 bg-white dark:bg-zinc-900 rounded-lg shadow-sm text-center">
                    <h1 className="mb-1 mt-4 font-semibold">Create your account</h1>
                    <p className="mb-8">Sign up with your Google account</p>
