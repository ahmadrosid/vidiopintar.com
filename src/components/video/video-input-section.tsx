  ...
  return (
    <div className="flex w-full flex-col items-center gap-3">
      ...
      <form onSubmit={handleSubmit} className="w-full space-y-2">
        ...
        <div className="flex w-full items-center gap-3 rounded-full border border-border bg-card px-2 pl-4 py-2">
          ...
          <input
            ...
            autoComplete="url"
            className="min-w-0 flex-1 appearance-none border-0 !bg-transparent text-[1rem] leading-normal text-foreground shadow-none outline-none ring-0 placeholder:text-[1rem] placeholder:text-muted-foreground focus:ring-0 focus-visible:ring-0 [&:-webkit-autofill]:text-[1rem] [&:-webkit-autofill::first-line]:text-[1rem] [&:-webkit-autofill]:[-webkit-text-fill-color:inherit] [&:-webkit-autofill]:[transition:background-color_9999s_ease-out_0s] [&:-webkit-autofill]:shadow-[inset_0_0_0_1000px_var(--card)]"
            required
          />
          <Button
            type="submit"
            disabled={isSubmitting}
            className="shrink-0 cursor-pointer rounded-full bg-accent px-6 text-accent-foreground hover:bg-accent/90"
          >
