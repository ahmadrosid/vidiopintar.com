      ...
      <form onSubmit={handleSubmit} className="w-full space-y-2">
        ...
        <div className="flex w-full items-center gap-3 rounded-2xl border border-white/10 bg-[#0b0f14] px-3 py-2 pl-4">
          ...
          <input
            ...
            autoComplete="url"
            className="min-w-0 flex-1 appearance-none border-0 !bg-transparent text-[1rem] leading-normal text-white shadow-none outline-none ring-0 placeholder:text-[1rem] placeholder:text-zinc-500 focus:ring-0 focus-visible:ring-0 [&:-webkit-autofill]:text-[1rem] [&:-webkit-autofill::first-line]:text-[1rem] [&:-webkit-autofill]:[-webkit-text-fill-color:white] [&:-webkit-autofill]:[transition:background-color_9999s_ease-out_0s]"
            required
          />
          <Button
            type="submit"
