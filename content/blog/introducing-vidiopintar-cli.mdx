...
For the AI chat features, you'll need an OpenAI API key:
...
- `OPENAI_MODEL` — Choose your model (default: `gpt-4o-mini`)
- `OPENAI_BASE_URL` — Use custom OpenAI-compatible APIs
